...
router.post('/waitlist', (req, res) => {
  ...
  var message = {
      ...
      "from_name": "Credit Swag Inc.",
      "to":[{"email": email}],
      "subject": "Thank you for your interest in Credit Swag",
  };
  ...
  // SEND THE EMAIL
  mandrill_client.messages.sendTemplate({"template_name": template_name, "message": message, "async": async, "ip_pool": ip_pool, "send_at": send_at}, function(result) {
    console.log(result);
  }, function(e) {
